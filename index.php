...
<html>
   ...
   <div class="grid">
    ...
    <form action="/index.php" method="POST" class="form login" id="loginform" >

      <div class="form__field">
        <label for="login__username"><svg class="icon">
            <use xlink:href="#icon-user"></use>
          </svg><span class="hidden">Username</span></label>
        <input autocomplete="username" id="login__username" type="text" name="username" id="username" class="form__input" placeholder="Username" required>
      </div>
      ...
      <div class="form__field">
        <input type="submit" value="Sign In">
                    ...
                    <div class="alert alert-danger alert-dismissible" role="alert" id="msgbox" style="display:none">
